...
const OfficerIssueFine = () => {
  ...
  const violationTypes = [
    { value: 'speeding', label: 'Speeding', baseAmount: 1500 },
    { value: 'red-light', label: 'Red Light Violation', baseAmount: 2000 },
    { value: 'parking', label: 'Illegal Parking', baseAmount: 500 },
    { value: 'reckless', label: 'Reckless Driving', baseAmount: 3000 },
    { value: 'phone', label: 'Mobile Phone Use', baseAmount: 1000 },
    { value: 'seatbelt', label: 'Seatbelt Violation', baseAmount: 500 }
  ];
  ...
  const calculateFine = (type: string, speed?: string, limit?: string) => {
    ...
    if (type === 'speeding' && speed && limit) {
      ...
      if (excess > 30) amount += 2000;
      else if (excess > 20) amount += 1500;
      else if (excess > 10) amount += 1000;
    }
  ...
  const handlePredictFine = async () => {
    ...
    try {
      ...
      // ML model returns fine amount directly (no conversion needed)
      const fineAmount = Math.round(data.predicted_fine);
      setMlPrediction(fineAmount);
      setFormData(prev => ({ ...prev, amount: fineAmount.toString() }));
    } catch (error) {
          ...
          <div className="space-y-6">
            ...
            <Card className="p-6 bg-gradient-card border-border/50">
              ...
              <div className="space-y-4">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <span className="font-semibold">Rs. 47,500</span>
                </div>
                <div className="flex justify-between items-center">
            ...
            <Card className="p-6 bg-gradient-card border-border/50">
              ...
              <div className="space-y-3">
                {[
                  { plate: 'XYZ-789', type: 'Speeding', amount: 'Rs. 2,500', time: '10 min ago' },
                  { plate: 'DEF-456', type: 'Red Light', amount: 'Rs. 2,000', time: '25 min ago' },
                  { plate: 'GHI-123', type: 'Parking', amount: 'Rs. 500', time: '1 hr ago' }
                ].map((fine, index) => (
            ...
            <Card className="p-6 bg-gradient-card border-border/50">
              ...
              <div className="space-y-2 text-sm text-muted-foreground">
                <p>• Speeding: Rs. 1,500 base + AI calculation</p>
                <p>• Red Light: Rs. 2,000 flat rate</p>
                <p>• Reckless Driving: Rs. 3,000 minimum</p>
                <p>• Parking: Rs. 500 standard rate</p>
                <p>• Mobile Phone: Rs. 1,000 flat rate</p>
                <p>• Seatbelt: Rs. 500 flat rate</p>
              </div>
            </Card>
          </div>
        </div>
